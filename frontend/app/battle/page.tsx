...
export default function BattlePage() {
  ...
  const handleMoveSelection = (move: Move) => {
    ...
    setTimeout(() => {
      ...
      const newPlayerHealth = Math.max(0, Number(battleState.playerHealth) - Number(opponentDamage))
  ...
  const calculateDamage = (attacker: Monster, move: Move, defender: Monster) => {
    ...
    return Math.floor(Number(baseDamage) * (Number(attackStat) / Number(defenseStat)) * randomFactor)
  }
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-screen bg-gradient-to-b from-purple-900 via-blue-900 to-black">
        ...
        {showMonsterModal && <MonsterSelectionModal monsters={monsters} onSelectMonster={handleMonsterSelection} />}
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-900 via-blue-900 to-black text-white p-4 overflow-hidden">
      <div className="container mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <BattleStats playerMonster={battleState.playerMonster!} opponentMonster={battleState.opponentMonster!} />
        </motion.div>
      </div>
      <AnimatePresence>
        {showVictoryScreen && (
              ...
              <div className="bg-gray-900 rounded-lg p-8 max-w-md text-center">
                ...
                {mintedMonster && mintedImage && (
                  <div className="mb-6">
                    ...
                    <p className={`${getRarityColor(mintedMonster.rarity)} text-lg`}>
